...
const firebaseConfig = {
  ...
  authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || 'palatero-demo.firebaseapp.com',
  projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || 'palatero-demo',
  storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || 'palatero-demo.appspot.com',
